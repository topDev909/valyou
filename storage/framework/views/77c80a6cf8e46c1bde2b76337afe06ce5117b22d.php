...
<ul class="nav nav-tabs main-nav-tabss mt-4">
    ...
    <li class="main-tab-item">
        <a class="main-tab-link <?php if($url == 'dashboard'){ echo 'active'; } ?>" href="artist/profile/<?php echo e($artist['id']); ?>" >dashboard</a>
    </li>
...
<?php /**PATH D:\xampp\htdocs\aug_client\resources\views/layouts/inner-navigation.blade.php ENDPATH**/ ?>