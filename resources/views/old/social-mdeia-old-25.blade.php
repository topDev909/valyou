                        ...
                        <div class="uploading-section card-body">
                            <div class="row">
                                <div class="col-lg-2 col-4 marginnone ">
                                    <img src="{{ isset($user_profile['photo']) ? $user_profile['photo'] : asset('/assets/images/users/avatar-1.jpg') }}"
                            ...
                            <div class="row for-padd-row">
                                ...
                                <div class="col-lg-8 col-sm-6 col-md-8 padding-n for-btn-post">
                                    ...
                                    <a href="{{ route('upload-artist') }}" type="button" class="btn post-now-btn"> Post Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card margin-n">
                                <div class="post-section card-body">
                                        ...
                                        <div class="col-lg-12 col-12">
                                            <div class="row">
                                                <div class="col-lg-9 col-9 profile_img_name">
                                                    <img class="post-section-artist-img rounded-circle" src="{{ URL::asset($item->artist->photo ?? '') }}" alt="">
                                                    <!--</div>-->
                                                    ...
                                                    <div class="inner_img_name">
                                                        <p class="post-section-artist-p1 only_name"> {{ $item->artist['brand'] }}</p>
                                    ...
                                    <div class="col-lg-12 col-12 padding-n mt-3">
                                       <a href="socialmedia/details/{{ $item->id }}"> <p class="post-section-para">{{ $item->description ?? '' }}</a></p>
                                    </div>
                                    <div class="col-lg-12 col-12 padding-n parent-for-video">
                                        ...
                                        <div class="overlay-for-video" id="overlay{{ $item->id }}" data-videoid="{{ $item->id }}" data-userid="{{ $item->artist['id'] }}">
                               ...
                               <!--new desc text-->
                                    <div class="social-media-profile-wrap">
                                        <div class="sm-left-wrap">
                                            <img src="{{ URL::asset($item->artist->photo ?? '') }}" alt=""
                                                 class="avatar-md rounded-circle">
                                            <div class="sm-left-desc for_web">
                                                <h2><?php echo isset($item->artist->brand)?$item->artist->brand:''; ?> </h2>
                                                <h5>Artist share price: <span class="color-white">${{ @$item->artist->stock_value }} VXD </span> <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}"> <span class="text-green">+ {{ @$item->artist->change_stock }}%</span></h5>
                            ...
                            <div style="display: none;" id="valyou-music-section-{{ $item->id }}">
                                <div class="container">
                                    ...
                                    <div class="container col-md-12 text-center mb-5 proceed-valyou-song-div">
                                        ...
                                        <button type="button" class="btn valyou-g-btn add_value" value="{{$item->id}}">Proceed to Valyou Song</button>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <ul class="list-inline social-container">
                                                        <li class="list-inline-item">
                                                            <a  target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ url()->full() }}/details/{{$item->id}}"
                                                        ...
                                                        <li class="list-inline-item">
                                                           <a target="_blank" href="https://twitter.com/intent/tweet?text={{$item->description}}&url={{url()->full()}}/details/{{$item->id}}" class="social-list-item bg-info text-white border-info">
                    ...
                    <div class="uploading-section-artist">
                        ...
                        <div class="tab-select nav nav-pills search-bar-web artist-maker-tabs" id="v-pills-tab"
                            ...
                            <a href="#all" class="active" id="all-tab" data-toggle="pill" role="tab" aria-controls="all"
                               ...
                               <a href="#{{ $key }}" class="unclicked sorting" type="{{ $key }}"  id="{{ $key }}-tab" data-toggle="pill" role="tab"
                               aria-controls="{{ $key }}" aria-selected="false">{{ $country['country_name']}}</a>
                               @endforeach
