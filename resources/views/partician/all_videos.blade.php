...
<style>
    ...
    .card-text:hover{
        cursor: pointer;
        /* background-color: rgba(255, 0, 147, 0.04); */
    }
...
<div class="social-post {{$item->id}}">
    ...
    <div class="mt-2 added-feature"> {{-- display buttons --}}
        <div class="row disp_control_button"> {{-- added on 11.29 --}}
            
            <div class="left-part col-sm-6 col-md-6 col-xs-12">                
                <div class="text-center">
                    <div class="left-card-part share-comments" data-commentid="{{ $item->id }}">
                        {{-- <div class="card-body body-p"> --}}
                            <p class="card-text text-comments"> <span><img class="hint-img" src="{{ asset('assets/images/comments.svg') }}"></span> COMMENTS </p>
                        {{-- </div> --}}
                    </div>
                </div>
                <div class="text-center mx-2">
                    <div class="left-card-part share-promote-song" data-promoteid="{{ $item->id }}">
                        {{-- <div class="card-body body-p"> --}}
                            {{-- <span><img class="mb-2 share-box-image" src="{{ asset('assets/images/promote.svg') }}"></span><p>Promote</p>                       --}}
                            <p class="card-text text-promote"><span><img class="hint-img" src="{{ asset('assets/images/promote.svg') }}" alt=""></span>PROMOTE</p>
                        {{-- </div> --}}
                    </div>
                </div>
            </div>
            ...
            <div class="right-part col-sm-6 col-md-6 col-xs-12">                
                <div class="text-center">
                    <div class="left-card-part share-valyou-music" data-valyouid="{{ $item->id }}">
                        {{-- <div class="card-body body-p"> --}}
                ...
                {{-- added in 11.29 --}}
                <div class="text-center">
                    <div class="share-invest" data-promoteid="{{ $item->id }}">
                        {{-- <button type="button" class="btn-invest-pink-grad" onclick="location.href='artist/profile/{{ isset($item->artist->id) ? $item->artist->id : ''; }}'"> 
                            Invest in Artist
                        </button> --}} {{-- disabled on 11.29 --}}
                        {{-- <div class="card-body body-p"> --}}
        ...
        </div> {{-- end added on 11.29 --}}
    </div>{{-- end display buttons --}}
...
<script>
    ...
    // added on 11.29
    $(document).on('click', '.share-invest', function(){
        alert('invest clicked');
    })
