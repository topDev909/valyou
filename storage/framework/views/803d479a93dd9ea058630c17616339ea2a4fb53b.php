                                ...
                                <div class="vw_single">
                                    <div class="vws_video">
                                        ...
                                        <?php else: ?>
                                            <a href="socialmedia/details/<?php echo e(isset($row->id)?$row->id:''); ?>">
                                        <?php endif; ?>
                                        <?php echo e(isset($row->artist->brand)?$row->artist->brand:''); ?></a></p>
                                            <p class="name-item"><?php echo e(isset($row->artist->about)?$row->artist->about:''); ?></p>
                                            <p class="price-item">Song Valyou: <strong> $<?php echo e(numberformat(@$row->artist->stock_value)); ?> </strong></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\aug_client\resources\views/watch.blade.php ENDPATH**/ ?>