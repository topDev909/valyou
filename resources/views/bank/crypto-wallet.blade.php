...
<div class="tab-select nav nav-pills crypto-wallet" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <div class="col-md-12">
            <div class="row">
                ...
                <div <?php echo check_role()=='1'? 'class="col-md-12 nav-responsive"':'class="col-md-8 nav-responsive"'; ?> <?php echo check_role()=='1'? 'style="overflow-x: scroll;"':''; ?>>
                <div class="nav nav-tabs tab-select" id="nav-tab" role="tablist" bis_skin_checked="1">
                    <a href="#personal-account" class="active" id="nav-personal-account" data-toggle="pill" role="tab"
                    ...
                    <a href="#artist" class="unclicked" id="nav-artist" data-toggle="pill" role="tab"
                        aria-controls="expression_of_interest" aria-selected="false"> Artist Company Funding </a>
                    ...
                    <?php } else {?>
                    <a href="{{ route('admin.role.switch',['role_id' => 2]) }}" style="color:#A69C9C !important;"> Artist Company Funding </a>
                    <a href="{{ route('admin.role.switch',['role_id' => 2]) }}" style="color:#A69C9C !important;"> Business </a>
                    <?php }?>
                    <?php  if(check_role() == 1) {?>
    ...
    <div class="card mini-stats-wid wallet">
        <div class="card-body mt-5">
            <div class="media-body text-center" >
                <h2 id="vxd-price" class="mb-0  active">$ {{ numberformat($wallet) }} VXD</h2>
                ...
                <h2 id="user_buying_vxd_amount" class="user_buying_vxd_amount mb-0">$ 10.00 VXD</h2>
    ...
    <div class="tab-pane fade show active " id="personal-account" role="tabpanel" aria-labelledby="nav-personal-account">
    <div class="wallet-button">
        <div class="bank_btns_wrap">
            <button class="btn btn-pink send_money">Send Money VXD</button>
            <button class="btn btn-green req_money">Withdraw Money VXD</button>
        ...
        <div class="paymento" style="width: 320px;">
            <input class="mx-auto" type="radio" name="payment_type" value="credit_card" style="margin-right: 10px !important;"> Fiat (Creditcard)  <img class="col-2" style="width:150px; max-width:170px; float:right;" src="{{asset('assets/images/payment_methods_logos-1.png')}}"> </img> <br>
            <input class="mx-auto mt-3" type="radio" name="payment_type" value="coin_deposit"  style="margin-right: 10px !important;"> Crypto <img class="col-2" style="margin-top: 10px;width: 120px;max-width: 150px;margin-right: 15px; float:right;" src="{{asset('assets/images/valyuxusdcPayment.png')}}"> </img>
        </div>   
        </div>
...
<!--                     @if (Session::has('success'))
                    ...
                    @endif -->
                    <form role="form" action="{{route('admin.stripe.post')}}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                        @csrf
                    ...
                    <form action="{{route('admin.crypto.post')}}" method="post" >
                        ...
                        <div class='form-row row'>
                            <div class='col-sm-12 col-md-12 form-group'>
                                ...
                                <input style="line-height: 1em;height: fit-content;" class='form-control customAmount' id="customAmountvalidate" type='number' name="amountVXD" placeholder="How much would you like to purchase?">
                            </div>
                                ...
                                <table id="datatable4" class="datatable table table-hover dt-responsive nowrap display"
                                    ...
                                    @foreach($transactions_data['personal'] as $row)
                                        ...
                                        <tr>
                                            ...
                                            <img src="{{ isset($row['from_profile']) ? asset($row['from_profile']) : asset('/assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle header-profile-user user-avatar-obj-fit-cover" >&nbsp;
                                            <p class="set_margin"> {{ $row['from_name']}}</p></div>
                                        	</td>
                                            <td>
                                            <div class="set_display">
                                            <img src="{{ isset($row['to_profile']) ? asset($row['to_profile']) : asset('/assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle header-profile-user user-avatar-obj-fit-cover" >&nbsp;
...
function buttonpayVXD(){
    ...
    if(amount == ''){
        ...
        $("#customAmountvalidate").css({'border-color': '#E2230E','box-shadow':'0 0 5px #E2230E'});
