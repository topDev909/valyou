...
<script>
    $(document).ready(function(){
      loadFollowersData(0,<?= $artist['id'] ?>,<?= $role ?>);
    
    function loadFollowersData(page,artist_id,role_type){
       $.ajax({
    ...
    $(document).on('click', '.loadbtn1', function(){
        ...
        loadFollowersData(pId,<?= $artist['id'] ?>,<?= $role ?>);
      });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/testvps/public_html/resources/views/allfollowers.blade.php ENDPATH**/ ?>