...
<div class="social-post <?php echo e($item->id); ?>">
    ...
    <div class="mt-2 added-feature"> 
        <div class="row disp_control_button"> 
            
            <div class="left-part col-sm-6 col-md-6 col-xs-12">                
                <div class="text-center">
                    <div class="left-card-part share-comments" data-commentid="<?php echo e($item->id); ?>">
                        
                            <p class="card-text text-comments"> <span><img class="hint-img" src="<?php echo e(asset('assets/images/comments.svg')); ?>"></span> COMMENTS </p>
                        
                    </div>
                </div>
                <div class="text-center mx-2">
                    <div class="left-card-part share-promote-song" data-promoteid="<?php echo e($item->id); ?>">
                        
                            
                            <p class="card-text text-promote"><span><img class="hint-img" src="<?php echo e(asset('assets/images/promote.svg')); ?>" alt=""></span>PROMOTE</p>
            ...
            <div class="right-part col-sm-6 col-md-6 col-xs-12">                
                <div class="text-center">
                    <div class="left-card-part share-valyou-music" data-valyouid="<?php echo e($item->id); ?>">
                ...
                <div class="text-center">
                    <div class="share-invest" data-promoteid="<?php echo e($item->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php /**PATH D:\xampp\htdocs\aus_client\resources\views/partician/all_videos.blade.php ENDPATH**/ ?>