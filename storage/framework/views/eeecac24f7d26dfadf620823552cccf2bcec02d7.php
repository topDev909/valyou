                    ...
                    <div class="uploading-section card-body row align-items-center">
                        ...
                        <div class="col-lg-5 col-sm-5 col-12">
                            <div class="row justify-content-end align-items-center">
                                <a href="<?php echo e(route('admin.upload-media')); ?>" title="Upload Video">
                                    <img class="uploading-section-upload-img width-40" src="<?php echo e(asset('assets/images/valyoux/video_player.svg')); ?>">
                                    <img class="uploading-section-upload-img " src="<?php echo e(asset('assets/images/valyoux/news_feed_post.svg')); ?>">
                                </a>
                                <a href="<?php echo e(route('admin.upload-media')); ?>" class="btn btn-pink btn-sm w-md waves-effect waves-light mr-3 post-now-button" style> Post Now</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php } ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\aug_client\resources\views/social-media.blade.php ENDPATH**/ ?>