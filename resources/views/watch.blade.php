...
<style>
    ...
    .vws_caption .name-item{
        color: black !important;
        font-size: 14px;
    }

    .vws_caption .price-item{
    ...
    .vws_caption .price-stock{
        font-size: 12px;
        color: #ff0093;
        font-weight: 700;
    }

    .vws_caption .price-percentage{
...
.px-2.show-info-pack .strong-stock{
    font-weight: 900;
    margin-left: 5px;
    margin-right: 5px;
}

.px-2.show-info-pack #stock-percentage{
    margin-left: 5px;
}

.px-4.show-info-detail{
    overflow: hidden;
    white-space: nowrap;
    font-size: 16px;
    display: flex;
...
.px-4.show-info-detail .img-song{
    margin-right: 5px;
}
...
#show-info-detail-short{
    color:#000000;
}

#show-info-detail-from{
    color:#a3aab5; 
    font-size: 16px;
}

#show-info-detail-valyou{
    color: #d2d5db;  
} 

#show-info-detail-price{
    color: blcak;
} 

#show-info-detail-category{
    color: #d2d5db;
}

    /*  */
@media(319px < width < 426px){
    .d-flex.align-items-center{
        padding-top: 5px;
    }
    .px-2.show-info-pack .show-stock{
        font-size: 12px;
    }
    .px-2.show-info-pack .strong-stock{
        font-size: 12px;
    }
    .px-2.show-info-pack .stock-arrow-down-img{
        width: 12px;
        height: 12px;
    }
    .px-2.show-info-pack #stock-percentage{
    ...
    .px-2.show-info-pack .stock-img-part{
        display: flex;
        align-items: center;
    }
    .px-4.show-info-detail .img-song{
    ...
    .px-4.show-info-detail .show-info-img{
        display: flex;
        align-items: center;
    }
    .px-4.show-info-detail #show-info-detail-title{
        font-size: 12px;
    }
    .px-4.show-info-detail #show-info-detail-from{
        font-size: 12px;
    }
    .px-4.show-info-detail #show-info-detail-valyou{
        font-size: 12px;
    }
    .px-4.show-info-detail #show-info-detail-price{
        font-size: 12px;
    }
    .px-4.show-info-detail #show-info-detail-category{
        font-size: 12px;
    }
    .px-4.show-info-detail #show-info-detail-short{
        font-size: 12px;
    }
}

@media(425px < width < 577px){
    .d-flex.align-items-center{
        padding-top: 5px;
    }
}
...
{{-- added new 2022.11.27 --}}
    <div class="row d-flex">
        {{-- main-left-board --}}
        <div class="col-md-8 col-sm-12">
            {{-- first card 11.28 static part complete--}}
            {{-- <div class="p-5 css-1ccbh2c">
                <div class="flex px-1" >
                    <div class="flex itmes-start">
                        <img src="http://localhost/aug_client/public/assets/uploads/artist/72921766.jpg" class="avatar-md avatar-md-cover rounded-circle" />
                    </div>
                    <textarea rows="2" aria-label="maximum height" placeholder="Share your Audio and Video Tracks" class="text-input"></textarea>                                        
                </div>               
                <div class="flex px-1" style="justify-content: space-between" style="border: #050f3f">
                    <div>
                        <span style="margin-right: 0.75rem; display: inline-flex;">
                            <img src="https://main.d5mab2z2xq5cw.amplifyapp.com/assets/eye_icon.svg" alt="eye_icon" style="width: 25px; height: 25px; margin: 0px; padding: 0px;">
                        </span>
                        <span style="display: inline-flex">
                            <img src="http://main.d5mab2z2xq5cw.amplifyapp.com/assets/music_icon.svg" alt="music-icon" style="display: block; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 25px;">
                        </span>
                    </div>
                    <button class="postNow w-60 css-ceydnk" style="background-image: linear-gradient(90deg, #fd4680, #fea75c);" >Post Now</button>
                </div>  
            </div> --}}
            {{-- end first card --}}
            {{-- second card --}}          
            {{-- <div class="social-media-profile-wrap1">
                <div class="d-flex align-items-center">
                    <img src="http://localhost/aug_client/public/assets/uploads/artist/72921766.jpg" class="avatar-md rounded-circle">
                    <div class="px-2">
                        <h2 class="mt-2" style="margin: 0">Drake</h2>
                        <p class="title"><span style="magrin-right: 2px; color:#d6d9df">Rapper&nbsp;</span>shared video track<i class="fa fa-youtube-play px-3" aria-hidden="true"></i></p>
                    </div>
                </div>
            ...
            <div id="watch_div">
                ...
                ?>
                    ...
                    @include('partician.all_videos',['videos'=>$records, 'display_ad' => "d-none"])
                <?php
                }
                ?>                 
            </div>
                        ...
                        <div class="all_videos">
                            @if(count($videos))
                                ...
                                <div class="vw_single">
                                    <div class="vws_video">
                                        @if(!empty($row->id))
                                            <a href="investor?vid={{ isset($row->id)?$row->id:'';}}">
                                        @else
                                        ...
                                        @else
                                            <a href="socialmedia/details/{{ isset($row->id)?$row->id:'';}}">
                                        @endif
                                        {{ isset($row->artist->brand)?$row->artist->brand:'' }}</a></p>
                                            <p class="name-item">{{ isset($row->artist->about)?$row->artist->about:'' }}</p>
                                            <p class="price-item">Song Valyou: <strong> ${{ numberformat(@$row->artist->stock_value) }} </strong></p>
                                        {{-- <p class="font-size-12">{{ videoCount($row->id); }} views {{ time_format($row->created_at) }}</p> --}}
                                            <p class="price-stock" >Stock Price <span><img src="https://main.d5mab2z2xq5cw.amplifyapp.com/assets/down-arrow-circle.svg" alt="" class="img-stock"></span> <strong class="price-vxd">$78.44 VXD </strong> <strong class="price-percentage">- 10.77%</strong></p>
                                        </div>
                                    </div>
                                @endforeach
                            @else
    ...
    <div class="container-fluid sub-part p-0">
        <div class="card disp-none-border">
            ...
            <div class="info-detail py-3" >
                <div class="marquee-part" >
                    <div class="px-4 d-flex align-items-center image-part">
                        <img src="http://localhost/aug_client/public/assets/uploads/artist/72921766.jpg" alt="" class="avatar-md rounded-circle">
                        <p class="my-auto personal_name">Kendric Larmar</p>
                    </div>
                    <div class="d-flex align-items-center">                
                        <div class="d-flex align-items-center scroll-marqee">
                            <div class="px-2 show-info-pack">
                                <div class="show-stock" id="show-stock">Stock Price</div>
                                <div class="strong-stock" id="strong-stock">  &nbsp;$78.44VXD</div>
                                <div class="stock-img-part"><img src="http://main.d5mab2z2xq5cw.amplifyapp.com/assets/down-arrow-circle.svg" class="stock-arrow-down-img"/></div>
                                <div class="stock-percentage" id="stock-percentage">  &nbsp;- &nbsp;10.77%</div>
                            </div>
                            <div class="px-4 show-info-detail">
                                <div class="show-info-img"><img src="http://main.d5mab2z2xq5cw.amplifyapp.com/assets/song-title.png" class="img-song"/></div> 
                                <div class="show-info-detail-title" id="show-info-detail-title"> Song Title :</div>
                                <div class="show-info-detail-from" id="show-info-detail-from"> &nbsp; Started From the Bottom </div>
                                <div class="show-info-detail-valyou" id="show-info-detail-valyou"> &nbsp;Song Valyou :</div>
                                <div class="show-info-detail-price" id="show-info-detail-price"> &nbsp;$1000,000,24,567 </div> 
                                <div class="show-info-detail-category" id="show-info-detail-category"> &nbsp;Artist Brand Listing Category : </div>
                                <div class="show-info-detail-short" id="show-info-detail-short"> &nbsp; Upcoming Artist / Rapper </div>
                            </div>    
                            
                            {{-- <div>
                                <p>Stock Price <span>$78.44VXD</span></p> &nbsp;
                                <div><img src="http://main.d5mab2z2xq5cw.amplifyapp.com/assets/down-arrow-circle.svg" class="stock-arrow-down-img"/></div>
                                <p> - 10.77%</p>
                            </div>
                            <div>
                                <div>
                                    ...
                                    &nbsp;&nbsp;
                                    <span class="text-gray-300 text-[16px]"> Song Valyou :<span class="font-bold text-black"> $1,000,000,24,567</span></span>&nbsp;
                                    &nbsp;
                                    <span class="text-gray-300 text-[16px]"> Artist Brand Listing Category : &nbsp; <span class="font-bold text-black"> Upcoming Artist / Rapper </span> </span>    
                                </div>
                            </div> --}}
            ...
            {{-- personal-carousel-part --}}
            <div class="personal-info pt-3">
                <div class="items-sort">
                    <p class="font-Bold" style="font-size: 0.75rem; line-height:1rem">Brand Sponsor <span class="color-red">Melbourne City</span><span><img src="{{ URL::asset('assets/images/dropdown.svg') }}" style="height:20px"></span></p>
                </div>
                <div class="see-all">
            ...
            <div class="carousel-info-part">
                <div class="verticalNav mt-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    {{-- <a href="#all" class="active sorting" id="all-tab" type="all" data-toggle="pill" role="tab" aria-controls="all" aria-selected="true"> All</a>
                    @foreach ($artist_by_country as $key=>$country)
                    <a href="#{{ $key }}" class="unclicked sorting" type="{{ $key }}"  id="{{ $key }}-tab" data-toggle="pill" role="tab" aria-controls="{{ $key }}" aria-selected="false">{{ $country['country_name']}}</a>
                    @endforeach --}}
