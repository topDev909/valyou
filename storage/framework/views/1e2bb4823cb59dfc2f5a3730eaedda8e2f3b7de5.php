        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="nav nav-tabs tab-select" id="nav-tab" role="tablist" bis_skin_checked="1">
                    ...
                    <?php } else {?>
                    <a href="<?php echo e(route('admin.role.switch',['role_id' => 2])); ?>" style="color:#A69C9C !important;"> Artist Company Funding </a>
    ...
    <div class="card mini-stats-wid wallet">
        <div class="card-body mt-5">
            <div class="media-body text-center" >
                <h2 id="vxd-price" class="mb-0  active">$ <?php echo e(numberformat($wallet)); ?> VXD</h2>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\aug_client\resources\views/bank/crypto-wallet.blade.php ENDPATH**/ ?>