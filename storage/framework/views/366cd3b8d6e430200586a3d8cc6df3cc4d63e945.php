<div class="tab-select nav nav-pills search-bar-web artist-maker-tabs" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a href="#<?php echo e($key); ?>" class="unclicked sorting" type="<?php echo e($key); ?>"  id="<?php echo e($key); ?>-tab" data-toggle="pill" role="tab" aria-controls="<?php echo e($key); ?>" aria-selected="false"><?php echo e($country['country_name']); ?></a>
...
<?php /**PATH D:\xampp\htdocs\aug_client\resources\views/partician/artist_markets.blade.php ENDPATH**/ ?>