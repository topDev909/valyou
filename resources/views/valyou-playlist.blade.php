...
<div class="tab-pane fade" id="nav-listen-earn" role="tabpanel" aria-labelledby="nav-listen-earn-tab">
    ...
    @if($single_videos)
    @foreach ($single_videos as $key=>$item)
    ...
    <div class="margin-n">
        <div>
            ...
            <div class="col-lg-12 col-12 padding-n parent-for-video">
                    <video controls id="video{{ $item->id }}" src="{{ asset($item->name) }}" data-video="{{ $item->artist->brand }}" class="video" type="video/mp4" controls playsinline></video>
			 </div>
        </div>
    </div>
    ...
    <section class="valyou-button btn_web pt-3">
        <div class="main-btn d-flex justify-content-between align-items-center" >
                <div class="main-valyou-button d-flex align-items-center share-comments" data-commentid="{{ $item->id }}">
                    <button class="comment-button d-flex align-items-center mr-2 ">
                        <span class="text-img mr-2">
                        <img class="mb-1 share-box-image img-fluid" src="{{ asset('assets/images/comments.svg') }}">
                        </span>
                        <span class="comment">COMMENTS</span>
                    </button>

                    <button class="comment-button d-flex align-items-center mr-2 share-promote-song" data-promoteid="{{ $item->id }}">
                        <span class="text-img mr-2">
                        <img class="mb-1 share-box-image img-fluid" style="width: 75%;" src="{{ asset('assets/images/promote.svg') }}">
                        </span>
                ...
                <button class="comment-button d-flex align-items-center mr-2 share-valyou-music" data-valyouid="{{ $item->id }}" style="height: 35px;">
        ...
        <section class="valyou-button mobile pt-3 card">
            <div class="main-btn d-flex justify-content-between align-items-center" >
                <div class="main-valyou-button d-flex align-items-center">
                    <button class="comment-button d-flex align-items-center mr-2  share-comments" data-commentid="{{ $item->id }}" style="border: none;">
                        <span class="text-img mr-2">
                        <img class="mb-1 share-box-image img-fluid" src="{{ asset('assets/images/comments.svg') }}">
                        </span>
                        <span class="comment">COMMENTS</span>
                    ...
                    <button class="comment-button d-flex align-items-center mr-2 share-promote-song" data-promoteid="{{ $item->id }}" style="border: none;">
                        <span class="text-img mr-2">
                        <img class="mb-1 share-box-image img-fluid" style="width: 75%;" src="{{ asset('assets/images/promote.svg') }}">
                        </span>
                        <span class="comment">PROMOTE</span>
                    ...
                    <button class="comment-button d-flex align-items-center mr-2 share-valyou-music" data-valyouid="{{ $item->id }}" style="height: 29px; padding:12px;">
                        <!-- <span class="text-img mr-2">
                        <!-- <img class="mb-1 share-box-image img-fluid" src="{{ asset('assets/images/comments.svg') }}"> -->
                        </span> 
            ...
            <div class="mt-5 social-media-profile-wrap">
                <div class="sm-left-wrap">
                    <img src="{{ URL::asset($item->artist->photo ?? '') }}" alt="" class="avatar-md avatar-md-cover rounded-circle" style="z-index: 999;">
                    <div class="sm-left-desc for_web mt-4">
                        <span>{{ isset($item->artist->brand) ? $item->artist->brand : ''; }}</span>
                        <span><i class="fa fa-clock-o" aria-hidden="true"></i> {{ isset($item->artist->about) ? $item->artist->about : ''; }}</span>
                    ...
                    <div class="sm-left-desc  for_mob">
                        <h2 class="sm-left-wrap">{{ isset($item->artist->brand) ? $item->artist->brand : ''; }}</h2>
                        <div class="scroll-marqee d-flex">
                        <p ><i class="fa fa-clock-o" aria-hidden="true"></i> {{ isset($item->artist->about) ? $item->artist->about : ''; }}</p>
                        <h5 >Artist share price: <span class="color-white mr-1">${{ numberformat(@$item->artist->stock_value) }} VXD </span>
                            @if ($item->artist->change_stock > 0)
                                <img class="uploading-section-artist-icon-img" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                <span class="text-green"> {{ numberformat(@$item->artist->change_stock) }}%</span>
                        </h5>
                    ...
                    @else
                        <img class="uploading-section-artist-icon-img ml-2" src="{{ asset('assets/images/valyoux/pink_arrow_circle_down.svg') }}">
                        <span class="text-danger"> {{ signFormat(@$item->artist->change_stock,0) }}%</span></h5>
            ...
            <!--Button End-->
            <div style="display: none;" id="valyou-music-section-{{ $item->id }}" class="valyou-music-hide valyou-media">
                ...
                <div class="p-3 chat-input-section">
                    <div class="row text-center">
                        ...
                        <div class="col-md-2 col-2 spycustcomment">
                            ...
                            <img style="transform: rotate(90deg); margin-top:6px;" class="mr-3 comment-btn" data-media="{{$item->id}}" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                        </div>
                    </div>
                </div>
            </div>
   ...
   @foreach($videos as $key=>$item)
    ...
    <div class="social-post {{$item->id}}">
        ...
        <section class="valyou-button btn_web pt-3 btn-pdning">
            <div class="main-btn d-flex justify-content-between align-items-center" >
                    ...
                    <button class="comment-button d-flex align-items-center mr-2 share-valyou-music" data-valyouid="{{ $item->id }}" style="height: 35px;">
                        ...
                        <button class="comment-button comment-btn d-flex align-items-center full-width" style="height:35px; border-color:#00FEC2" onclick="location.href='artist/profile/{{ isset($item->artist->id) ? $item->artist->id : ''; }}'">
        ...
        <div class="col-lg-12">
            ...
            <h2 class="artist-name">{{ isset($item->artist->brand) ? $item->artist->brand : ''; }}</h2>   
            <div class="sm-left-wrap">
                ...
                <div class="sm-left-desc for_web mt-4">
                    ...
                    <div class="scroll-marqee" style="display: flex;">
                        <span><i class="fa fa-clock-o mr-2" aria-hidden="true" ></i> {{ isset($item->artist->about) ? $item->artist->about : ''; }}</span>
                        <span><i class="fa fa-music mr-2" aria-hidden="true"></i>Song Title:Started from the Bottom</span>
                        
                        <h5>Artist share price: <span class="color-white">${{ numberformat(@$item->artist->stock_value) }} VXD </span>
                            @if ($item->artist->change_stock > 0)
                                <img class="uploading-section-artist-icon-img ml-2" src="{{ asset('assets/images/valyoux/green_arrow_price_going_up.svg') }}">
                                <span class="text-green">+ {{ numberformat(@$item->artist->change_stock) }}%</span>
                        </h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control " required="" value="{{ Auth::user()->first_name}}" name="first_name" id="first_name" placeholder="First Name">
                                                    </div>
                        <div class="form-group">
                            <label>Last Name</label>
                            <input type="text" class="form-control " required="" value="{{ Auth::user()->last_name }}" name="last_name" id="last_name" placeholder="Last Name">
                                                    </div>
                    
                    <div class="form-group">
                            <label>Mobile Number</label>
                            <input type="text" class="form-control" required="" value="{{ Auth::user()->phone_number }}" name="mobile" id="mobile" placeholder="Dob">
                        </div>
                      
                        <div class="form-group">
                            <label>Dob</label>
                            <input type="date" class="form-control" required="" value="{{ Auth::user()->dob }}" name="dob" id="dob" placeholder="Dob">
                        </div>
                        <div class="form-group">
                            <label>Profile</label>
                            <input type="file" class="form-control" required="" accept="image/*" value="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}" name="avatar" id="avatar" placeholder="Profile">
                            
                        </div>
                        <div class="form-group">
                        <img id="blah" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}" style="width: 50px;height: auto;border-radius:70px;">
                        </div>
