...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="float-right">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('artist_delete')): ?>
                    ...
                    <table id="example1" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tr>
                            ...
                            <th><?php echo e(ucwords(str_replace('_',' ','category'))); ?></th>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('artist_show')): ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                <th><?php echo e(ucwords(str_replace('_',' ','spotify'))); ?></th>
                                <td id="spotify" align="center"></td>
                            </tr>
                            <tr>
                                <th><?php echo e(ucwords(str_replace('_',' ','soundcloud'))); ?></th>
                                <td id="soundcloud" align="center"></td>
                            </tr>
                            <tr>
                                <th><?php echo e(ucwords(str_replace('_',' ','applemusic'))); ?></th>
    ...
    <script>
        $(function(){
            ...
            $(document, this).on('click', '.view', function () {
                let id = $(this).attr('id');
                $.ajax({
                    url: `<?php echo e(url(request()->segment(1).'/show/')); ?>/${id}`,
                    dataType: "json",
            ...
            document.getElementById('delete_all').addEventListener('click', () => {
                ...
                if (checkboxes.length > 0) {
                    ...
                    let ajax = async () => {
                        await fetch(`artist/artist/delete_all`, {
                            method: "post",
                            headers: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/testvps/public_html/resources/views/artist/list.blade.php ENDPATH**/ ?>