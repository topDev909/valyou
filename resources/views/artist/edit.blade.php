                    ...
                    <form method="POST" action="artist-store" class="custom-validation" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" step="any" name="dividend_payments" value="{{ $artist->dividend_payments ?? '' }}"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" step="any" name="music_fan_investor" value="{{ $artist->music_fan_investor ?? '0' }}"/>
                        </div>
                        <div class="form-group">
