...
@section('content')
    ...
    <div class="row">
        ...
        <div class="row" style="margin-top:2.5rem;" id="show_more_revenue">
                ...
                @component('common-components.index-widget')
                    @slot('title') Sell Stock Revenue @endslot
                    @slot('price') 
                    @if(isset($revenueDetail))
                    $ {{$revenueDetail->sell_stock}} 
                    @endif
                    @endslot
                    @slot('icon') bx bx-copy-alt font-size-24 @endslot
                @endcomponent
                ...
                @component('common-components.index-widget')
                    @slot('title') Buy Stock Revenue @endslot
                    @slot('price')
                    @if(isset($revenueDetail))
                    $ {{$revenueDetail->buy_stock}} 
                    @endif
                    @endslot
                    @slot('icon') bx bx-archive-in font-size-24 @endslot
                @endcomponent
                ...
                @component('common-components.index-widget')
                    @slot('title') Stripe Charges @endslot
                    @slot('price') $ {{$revenueDetail->credit_card ?? 0 }} @endslot
                    @slot('icon') bx bx-purchase-tag-alt font-size-24 @endslot
                @endcomponent
        
        		@component('common-components.index-widget')
                    @slot('title') Audio Streaming Fee @endslot
                    @slot('price')
                    @if(isset($setting))
                    {{$setting->audio_streaming_fee}} 
                    @endif
                    @endslot
                    @slot('icon') bx bx-purchase-tag-alt font-size-24 @endslot
                @endcomponent
        		@component('common-components.index-widget')
                    @slot('title') Video Streaming Fee @endslot
                    @slot('price')
                    @if(isset($setting))
                    {{$setting->video_streaming_fee}} 
                    @endif
                    @endslot
                    @slot('icon') bx bx-purchase-tag-alt font-size-24 @endslot
                @endcomponent
        @component('common-components.index-widget')
                    @slot('title') Admin Video Streaming Fee @endslot
                    @slot('price') 
                    @if(isset($setting))
                    {{$setting->admin_video_streaming_fee}} 
                    @endif
                    @endslot
                    @slot('icon') bx bx-purchase-tag-alt font-size-24 @endslot
                @endcomponent
        @component('common-components.index-widget')
                    @slot('title') Admin Audio Sreaming Fee @endslot
                    @slot('price')
                    @if(isset($setting))
                    {{$setting->admin_audio_streaming_fee}} 
                    @endif
                    @endslot
                    @slot('icon') bx bx-purchase-tag-alt font-size-24 @endslot
                @endcomponent
        @component('common-components.index-widget')
                    @slot('title') Advertisement Fee @endslot
                    @slot('price')
                    @if(isset($setting))
                    {{$setting->advertisement_fee}} 
                    @endif
                    @endslot
                    @slot('icon') bx bx-purchase-tag-alt font-size-24 @endslot
                @endcomponent
