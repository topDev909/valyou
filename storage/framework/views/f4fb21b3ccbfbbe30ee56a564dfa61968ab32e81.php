...
<div class="row">
        <div class="col-md-12 col-lg-12 order-md-2 order-lg-1">
           <!--  <div class="tab-select">
             ...
             <input type="hidden" name="user_id" id="user_id" value="<?php echo e($artist['id']); ?>">
             <div class="page_section">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/testvps/public_html/resources/views/artist/videos.blade.php ENDPATH**/ ?>