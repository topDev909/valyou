...
@section('content')
<!-- Modal -->
{{-- <div class="modal fade video-modal" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="background-color: green">
...
{{-- <div class="row" style="background-color: #b4b7b7">
    <div class="col-lg-12">
...
<div class="main-board">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <div class="p-5 css-1ccbh2c">
                ...
                <div class="flex justify-between">
                    <div class="flex p-3">
                        <span>
                            <img src="https://main.d5mab2z2xq5cw.amplifyapp.com/assets/eye_icon.svg" alt="eye_icon" style="display: block; max-width: 100%; width: initial; height: initial; margin: 0px; padding: 0px; width:25px;">
                        </span>
                        <span>
                    ...
                    <button class="postNow w-60 css-ceydnk" style="display: inline-flex;" >Post Now</button>
                </div>  
                <div class="videothumbnail_wrapper card">
                    <div class="flex px-1" >
                        <div class="flex itmes-start">
                ...
                <div class="personal-info">
                    <div class="social-media-profile-wrap1">
                        <div class="sm-left-wrap">
                            ...
                            <div class="sm-left-desc">
                                <h2>Drake</h2>
                                <p class="title">Rapper shared video track<i class="fa fa-youtube-play" aria-hidden="true"></i></p>
                            </div>
                        </div>
                        <div class="sm-right-wrap">
                            Major Artist
        ...
        <div class="col-4"> 
            <div id="watch_div2">
                <div class="videothumbnail_wrapper card">
                    <div class="vw_head p-3" style="display: inline-flex">
                        <div>
                            <p style="font-size: 16px; font-weight: bold"> Trending Music Artists Brands in Stock Market</p>
                        </div>
                        <div class="px-3 flex">
                            <p style="color: green; font-size:16px">UP<span><img src="http://main.d5mab2z2xq5cw.amplifyapp.com/assets/greeen-arrow.svg" style="font-size: 20px"/></span></p>
                            <p style="font-size: 16px; font-weight: bold; color: rgb(255, 0, 147)">DOWN<span><img src="http://main.d5mab2z2xq5cw.amplifyapp.com/assets/down-arrow-circle.svg" style="font-size: 20px"></span></p>
                        </div>
                    </div>
                </div>
                <div class="videothumbnail_wrapper card">
    ...
    {{-- personal-info-board --}}
    <div class="hidden lg:block lg:border rounded lg:p-4 lg:shadow-lg lg:shadow-gray-300">
        <div class="py-3">
            <div class="flex" >
                <div class="px-4">
                    <img src="http://localhost/aug_client/public/assets/uploads/artist/72921766.jpg" alt="" class="avatar-md rounded-circle" style="width: 50px; height:50px;">
                </div>
                <div class="px-2" style="display: inline-flex">
                    <p style="font-size: 16px; font-weight: bold; font-color: rgba(59,130,246,.5);">Kendric Larmar -</p>
                    &nbsp;
                    <div class="px-2" style="border: 1px solid gray; border-radius: 8px">
                        <p style="font-size: 16px">Stock Price<span>$78.44VXD</span><span></span><img src="{{ URL::asset('assets/images/circular-filled-dropdown-icon.svg') }}" style ="height: 20px" /><span>- 10.77%</span></p>
                    </div>
                    <div class="px-2">
                        <p style="font-size: 16px"><span><img src="http://main.d5mab2z2xq5cw.amplifyapp.com/assets/song-title.png" style="height: 20px"/></span> Song Title :<span>Started From the Bottom</span><span>Song Valyou :</span><span>$1000,000,24,567</span> <span>Artist Brand Listing Category : </span><span>Upcoming Artist / Rapper</span> </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="personal-info">
            <div class="items-sort">
                <p class="font-Bold">Brand Sponsor <span class="color-red">Melbourne City</span>  <span> <img src="{{ URL::asset('assets/images/dropdown.svg') }}" style="height:20px"> </span> </p>
            </div>
            <div class="see-all">
                <p>Bid Now (See All)</p>
            </div>                  
        ...
        <div class="carousel-info-part">
            <ul style="list-style-type: none; display: flex; flex-direction: row; padding: 0">
