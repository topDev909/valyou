...
@section('content')
    ...
    @component('common-components.breadcrumb')
        @slot('title') Business Profile <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editUserModal">
        ...
        <div class="row">
            <div class="col-12">
                <div class="ctc-single-profile">
                    <img src="{{ isset($business->photo) ? asset($business->photo) : asset('/assets/images/users/avatar-1.jpg') }}" alt="">
                    <div class="sph-text">
                      <h4>{{ @$business->brand }} </h4>
                      <h6>{{ @$business->occupation }}</h6>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" name = "brand" value="{{ @$business->brand }}">
                    </div>
                    <div class="form-group">
                            <label>Business Occupation</label>
                            <input type="text" class="form-control" name = "occupation" value="{{ @$business->occupation }}">
                    </div>
                    <div class="form-group">
                            <label>About</label>
                            <input type="text" class="form-control" name = "about" value="{{ @$business->about }}">
                    </div>
