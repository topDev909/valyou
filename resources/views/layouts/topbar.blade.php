                ...
                <div class=" mr-2 topbar-new topbar-new-mob">
                                        ...
                                        <div class="simplebar-offset" style="right: -17px; bottom: 0px;">
                                            <div class="simplebar-content-wrapper" style="height: auto; overflow: hidden scroll;">
                                                <div class="simplebar-content" style="padding: 0px;">
                                                    ...
                                                    @if($user->is_admin)
                                                     <a href="{{ route('admin.role.switch',['role_id' => 1]) }}" class="text-reset notification-item">
                                                        <div class="media">
                                                            <div class="avatar-xs mr-3">
                                                                <span class="avatar-title rounded-circle font-size-16">
                                                                    <img src="{{ asset('assets/images/valyoux/accountSwitch.svg') }}" alt="{{ asset('assets/images/valyoux/accountSwitch.svg') }}" width="16" />
                                                                </span>
                                                            </div>
                                                            <div class="media-body">
                                                                <h5>Admin</h5>
                    ...
                    <div class="dropdown d-inline-block">
                        <a href="{{ $url }}" class="btn header-item waves-effect">
                            <img class="rounded-circle header-profile-user user-avatar-obj-fit-cover" src="{{ $user_image }}"
                                 alt="Header Avatar">
                                        ...
                                        <!--  <h6 class="mt-0 mb-1">Notifications</h6> -->
                                            ...
                                            ?>
                                                <a href="" class="text-reset notification-item  {{ $class }}" >
                                                    <div class="media">
                                                            <img class="mr-3 rounded-circle avatar-xs"  src="{{ asset($row['from_user']['avatar']) }}" alt="{{ asset('assets/images/valyoux/artist.svg') }}" width="16" />
                                                        <div class="media-body">
                                                        <div class="font-size-12 text-muted">
                                                            <p class="notification_text">{{ $row->notification_text }}</p>
                                                            <?php if($row->status == 0){ ?>
                                                            <img class="notification_image" src="{{ URL::asset('/assets/images/valyoux/message icon.svg') }}" width="20">
                                                            <?php  }else{ ?>
                                                            <img class="notification_image" src="{{ URL::asset('/assets/images/valyoux/open.svg') }}" width="20">
                                                            <?php }?>
                                                        </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <a href="{{ route('admin.notifications') }}"><p>View All</p></a>
