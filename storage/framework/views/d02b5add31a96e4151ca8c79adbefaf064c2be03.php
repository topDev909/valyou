...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" step="any" name="dividend_payments" value="<?php echo e($artist->dividend_payments ?? ''); ?>"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" step="any" name="music_fan_investor" value="<?php echo e($artist->music_fan_investor ?? '0'); ?>"/>
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/testvps/public_html/resources/views/artist/edit.blade.php ENDPATH**/ ?>